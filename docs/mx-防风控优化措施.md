...
- **晚间兜底断开（2026-09-02，2026-09-03 起改为 23:30-23:55）**：23:30-23:55 之间随机一秒，若 MX 仍在线（如手动登录后忘断，无论会话来源是自动还是手动）一律强制断开（关标签页式 abort）——正常三段窗口最晚 22 点前已关窗，这是防「人走了页面还开着」的最后保险，当天只执行一次。
