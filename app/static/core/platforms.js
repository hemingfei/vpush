...
const TRUTH_ICON = `<svg class="pt-icon" viewBox="0 0 24 24" fill="none" aria-hidden="true"><rect width="24" height="24" rx="5" fill="currentColor"/><rect x="4.5" y="6.5" width="3.8" height="3.3" rx="0.4" fill="#2DD0B3"/><path d="M10 6.5h9.5v3.3H14.2v7.7h-4.2V6.5z" fill="#ffffff"/></svg>`;
