...
const state = {
  ...
  newsRtSourceId: "",
  newsResearchItems: [],
  newsResearchOffset: 0,
  newsResearchHasMore: false,
  newsResearchLatestId: 0,
  newsResearchPending: [],
  newsResearchSeq: 0,
  newsResearchObserver: null,
  newsResearchExpanded: new Set(),
  newsResearchSources: [],
  newsResearchSourceId: "",
  newsResearchQuery: "",
  adminKolsPlatform: "",
  adminKols: [],
  adminKolsQ: "",
...
function avatarHtml(name, url, platform) {
  const inner = url && !_deadImgUrls.has(url) ? `<img class="kol-avatar" src="${escapeHtml(url)}" alt="" loading="lazy" data-av-name="${escapeHtml(name)}" onerror="avatarImgError(this)">` : `<div class="kol-avatar">${escapeHtml(avatarText(name))}</div>`;
...
let kolView, loadAdminKols, loadAdminVocab, switchAdminKolsPlatform, adminKolsApplyFilter, adminKolsClearFilter, adminKolsPage, adminKolToggleSelect,
  ...
  adminSaveTags, adminSaveAliases, adminMaintainTags, adminBackfillTags, adminSetTier, adminBatchSystemToggle, adminKolWebhook, adminKolWebhookToggle, adminKolWebhookRegenerate,
