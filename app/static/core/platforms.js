...
const TRUTH_ICON = `<svg class="pt-icon" viewBox="3.6 4.85 16 16" fill="currentColor" aria-hidden="true"><rect x="4.4" y="6.4" width="3.6" height="3.2"/><rect x="9.7" y="6.4" width="9.2" height="3.2"/><rect x="9.7" y="10.4" width="3.7" height="8.9"/><rect x="15.3" y="15.6" width="3.5" height="3.1" rx=".4" opacity=".62"/></svg>`;
const MX_ICON = `<svg ${ICON_ATTRS}><path d="M3 12l7-7 2 2 3-3 6 6-6 6-3-3-2 2-7-7z"/></svg>`;
const SYSTEM_ICON = `<svg class="pt-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><rect x="3" y="3" width="18" height="18" rx="2"/><circle cx="12" cy="12" r="3"/><path d="M12 2v2M12 20v2M2 12h2M20 12h2"/></svg>`;
